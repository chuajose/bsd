...
class App_KernelDevDebugContainer extends Container
{
    ...
    protected function getCreateLeadCommandService()
    {
        ...
        $this->privates['App\\UI\\Command\\CreateLeadCommand'] = $instance = new \App\UI\Command\CreateLeadCommand(new \App\Infrastructure\Persistence\Elastic\Lead\LeadRepository($this, $this->getParameter('elastic')));
