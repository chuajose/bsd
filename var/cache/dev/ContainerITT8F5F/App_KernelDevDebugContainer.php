...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->methodMap = [
            'App\\UI\\Http\\Web\\Controller\\DefaultController' => 'getDefaultControllerService',
    ...
    /**
     * Gets the public 'App\UI\Http\Web\Controller\DefaultController' shared autowired service.
     *
     * @return \App\UI\Http\Web\Controller\DefaultController
     */
    protected function getDefaultControllerService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/Controller/AbstractController.php';
        include_once \dirname(__DIR__, 4).'/src/UI/Http/Web/Controller/DefaultController.php';

        $this->services['App\\UI\\Http\\Web\\Controller\\DefaultController'] = $instance = new \App\UI\Http\Web\Controller\DefaultController();
        ...
        $instance->setContainer((new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'router' => '?',
            'session' => '?',
        ]))->withContext('App\\UI\\Http\\Web\\Controller\\DefaultController', $this));
    ...
    protected function getCache_AppService()
    {
        ...
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('mRcv9E0-kf', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    protected function getConsole_CommandLoaderService()
    {
        ...
        return $this->services['console.command_loader'] = new \Symfony\Component\Console\CommandLoader\ContainerCommandLoader(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\UI\\Command\\CreateActivityCommand' => ['privates', 'App\\UI\\Command\\CreateActivityCommand', 'getCreateActivityCommandService', false],
            'App\\UI\\Command\\CreateLeadCommand' => ['privates', 'App\\UI\\Command\\CreateLeadCommand', 'getCreateLeadCommandService', false],
            ...
            'App\\UI\\Command\\CreateActivityCommand' => 'App\\UI\\Command\\CreateActivityCommand',
            'App\\UI\\Command\\CreateLeadCommand' => 'App\\UI\\Command\\CreateLeadCommand',
    ...
    /**
     * Gets the private 'App\Infrastructure\Persistence\Elastic\Lead\LeadRepository' shared autowired service.
     *
     * @return \App\Infrastructure\Persistence\Elastic\Lead\LeadRepository
     */
    protected function getLeadRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'/src/Infrastructure/Persistence/Elastic/ElasticRepository.php';
        include_once \dirname(__DIR__, 4).'/src/Domain/Lead/LeadRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'/src/Infrastructure/Persistence/Elastic/Lead/LeadRepository.php';

        return $this->privates['App\\Infrastructure\\Persistence\\Elastic\\Lead\\LeadRepository'] = new \App\Infrastructure\Persistence\Elastic\Lead\LeadRepository($this, $this->getParameter('elastic'));
    }

    /**
     * Gets the private 'App\UI\Command\CreateActivityCommand' shared autowired service.
     *
     * @return \App\UI\Command\CreateActivityCommand
     */
    protected function getCreateActivityCommandService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/console/Command/Command.php';
        include_once \dirname(__DIR__, 4).'/src/UI/Command/CreateActivityCommand.php';

        $this->privates['App\\UI\\Command\\CreateActivityCommand'] = $instance = new \App\UI\Command\CreateActivityCommand(($this->privates['App\\Infrastructure\\Persistence\\Elastic\\Lead\\LeadRepository'] ?? $this->getLeadRepositoryService()));

        $instance->setName('app:create-activity');

        return $instance;
    }

    /**
     * Gets the private 'App\UI\Command\CreateLeadCommand' shared autowired service.
     *
     * @return \App\UI\Command\CreateLeadCommand
     */
    protected function getCreateLeadCommandService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/console/Command/Command.php';
        include_once \dirname(__DIR__, 4).'/src/UI/Command/CreateLeadCommand.php';

        $this->privates['App\\UI\\Command\\CreateLeadCommand'] = $instance = new \App\UI\Command\CreateLeadCommand(($this->privates['App\\Infrastructure\\Persistence\\Elastic\\Lead\\LeadRepository'] ?? $this->getLeadRepositoryService()));

        $instance->setName('app:create-lead');
