 ...
 * @final
 */
class BySidecar_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->methodMap = [
            'BySidecar\\UI\\Http\\Web\\Controller\\DefaultController' => 'getDefaultControllerService',
    ...
    /**
     * Gets the public 'BySidecar\UI\Http\Web\Controller\DefaultController' shared autowired service.
     *
     * @return \BySidecar\UI\Http\Web\Controller\DefaultController
     */
    protected function getDefaultControllerService()
    {
        ...
        $this->services['BySidecar\\UI\\Http\\Web\\Controller\\DefaultController'] = $instance = new \BySidecar\UI\Http\Web\Controller\DefaultController();
        ...
        $instance->setContainer((new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'router' => '?',
            'session' => '?',
        ]))->withContext('BySidecar\\UI\\Http\\Web\\Controller\\DefaultController', $this));
    ...
    protected function getCache_AppService()
    {
        ...
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('BZhP5CQRzn', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    protected function getCache_SystemService()
    {
        ...
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('fkeCSnhL7v', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    protected function getCacheWarmerService()
    {
        ...
        }, 1), true, ($this->targetDir.''.'/BySidecar_KernelDevDebugContainerDeprecations.log'));
    }
    ...
    private function getDynamicParameter(string $name)
    {
        switch ($name) {
            ...
            case 'debug.container.dump': $value = ($this->targetDir.''.'/BySidecar_KernelDevDebugContainer.xml'); break;
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.container_class' => 'BySidecar_KernelDevDebugContainer',
